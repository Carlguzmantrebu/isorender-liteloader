...
public class RenderScreen extends GuiScreen {
    ...
    public RenderScreen(AreaSelection selection) {
        ...
        System.out.println("[IsometricRender] RenderScreen created for " + selection.getSizeX() + "x" + selection.getSizeY() + "x" + selection.getSizeZ() + " blocks");
    }
    
    @Override
    public void initGui() {
        System.out.println("[IsometricRender] initGui() - width=" + this.width + ", height=" + this.height);
        ...
        System.out.println("[IsometricRender] initGui() complete - " + this.buttonList.size() + " buttons");
    }
    
    @Override
    protected void actionPerformed(GuiButton button) throws IOException {
        System.out.println("[IsometricRender] Button " + button.id + " pressed");
